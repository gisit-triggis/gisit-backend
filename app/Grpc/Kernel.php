...
use Spiral\RoadRunner\GRPC\Exception\NotFoundException as ExceptionNotFoundException;
...
class Kernel implements KernelContract
{
    ...
    protected function invoke(
        ...
        if (!isset($this->services[$service])) {
            throw new ExceptionNotFoundException("Service `{$service}` not found.", StatusCode::NOT_FOUND);
        }
